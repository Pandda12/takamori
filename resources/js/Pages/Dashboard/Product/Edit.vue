...
const form = reactive({
    ...
    number_of_tea_bags: props.product.number_of_tea_bags ?? null,
    tea_weight: props.product.tea_weight,
...
function update() {
    ...
    router.patch(`/dashboard/products/${form.id}`, form)
}

</script>

<template>
    <AuthenticatedLayout page-title="Обновить товар">
        <form
